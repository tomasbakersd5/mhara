(function ( $ ) {
	...
	$.fn.showclock = function(obj) {
		...
		html+="<li class='days'><div class='upcoming-event-counter-box'>"
	    ...
	    html+="<li class='hours'><div class='upcoming-event-counter-box'>"
	    ...
	    html+="<li class='minutes'><div class='upcoming-event-counter-box'>"
	    ...
	    html+="<li class='seconds'><div class='upcoming-event-counter-box'>"
